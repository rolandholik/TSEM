		       ...
		       kernel_cap_t *inheritable, kernel_cap_t *permitted)
{
	...
	ep->CELL.capability.effective.mask = *effective;
	ep->CELL.capability.inheritable.mask = *inheritable;
	ep->CELL.capability.permitted.mask = *permitted;
...
static void tsem_bprm_committed_creds(struct linux_binprm *bprm)
{
